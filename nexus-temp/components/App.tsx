      ...
      <section id="apps" className="py-32 relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="text-center mb-20">
             <h2 
                className="text-4xl md:text-5xl font-bold text-white mb-4 drop-shadow-[0_0_10px_rgba(255,255,255,0.2)] font-display"
             ...
             <p 
                className="mt-4 text-cosmic-teal font-bold tracking-widest text-sm uppercase font-display"
                style={{ fontFamily: "'Cinzel Decorative', cursive" }}
             >
                {t.home.selectApp}
             </p>
