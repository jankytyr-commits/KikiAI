...
# Check contents of moved folders
List-FtpDirectory "/www/apps/kikiai/Chats/"
List-FtpDirectory "/www/apps/kikiai/Config/"

# Check for leftovers in root
