(function () {
    console.log('[STAR-MAP] Script started');
    const canvas = document.getElementById('star-canvas');
    if (!canvas) {
        console.error('[STAR-MAP] Canvas not found!');
        return;
    }
    console.log('[STAR-MAP] Canvas found:', canvas);
    ...
    const resize = () => {
        ...
        console.log('[STAR-MAP] Resized to:', width, 'x', height);
    };
    ...
    console.log('[STAR-MAP] Created', STAR_COUNT, 'stars');
    ...
    console.log('[STAR-MAP] Starting render loop');
    render();
})();
