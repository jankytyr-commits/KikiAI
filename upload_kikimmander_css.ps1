...
try {
    ...
    Write-Host "  ✓ Text is now white and visible" -ForegroundColor Green
    Write-Host "  ✓ Buttons have better contrast (teal glow)" -ForegroundColor Green
    Write-Host "  ✓ Hover effects improved" -ForegroundColor Green
}
catch {
